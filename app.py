...
.hero-badge {
    ...
    align-items: center;
    gap: 6px;
    background: rgba(99,57,242,0.18);
...
.stat:hover { border-color: rgba(255,255,255,0.14); }
...
.stTextArea > div > div > textarea {
    background: rgba(7,5,30,0.7) !important;
...
.stTextArea > div > div > textarea:hover {
    ...
    background: rgba(99,57,242,0.07) !important;
    box-shadow: 0 0 0 4px rgba(99,57,242,0.08), inset 0 1px 0 rgba(255,255,255,0.04) !important;
}

.stTextArea > div > div > textarea:focus {
    border-color: rgba(139,92,246,0.8) !important;
    background: rgba(99,57,242,0.09) !important;
    box-shadow: 0 0 0 5px rgba(99,57,242,0.15), inset 0 1px 0 rgba(255,255,255,0.05) !important;
...
.stButton > button {
    ...
    box-shadow: 0 4px 24px rgba(99,57,242,0.35) !important;
}

.stButton > button:hover {
    transform: translateY(-2px) !important;
    box-shadow: 0 8px 32px rgba(99,57,242,0.55) !important;
...
.result-fake {
    ...
    box-shadow: 0 0 40px rgba(239,68,68,0.1), inset 0 1px 0 rgba(255,255,255,0.04);
}

.result-true {
    background: linear-gradient(135deg, rgba(16,185,129,0.1) 0%, rgba(52,211,153,0.05) 100%);
    border: 1.5px solid rgba(52,211,153,0.4);
    box-shadow: 0 0 40px rgba(52,211,153,0.1), inset 0 1px 0 rgba(255,255,255,0.04);
}
...
.chip-f:hover { background: rgba(239,68,68,0.16); border-color: rgba(239,68,68,0.4); }
...
.chip-t:hover { background: rgba(52,211,153,0.16); border-color: rgba(52,211,153,0.4); }
...
user_input = st.text_area("x", placeholder="Type or paste a health claim here...", height=130, label_visibility="collapsed")
...
<div class="footer">
    ...
    <div class="footer-sub">
        ...
        Built with Python &nbsp;·&nbsp; Scikit-learn &nbsp;·&nbsp; Streamlit &nbsp;·&nbsp; NLP
    </div>
</div>
""", unsafe_allow_html=True)
